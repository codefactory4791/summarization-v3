...
def load_processed_dataset(dataset_path):
...
def train_model(model_checkpoint, batch_size, model, tokenized_train, tokenized_valid, data_collator, tokenizer):
...
def master_function(dataset_path, output_path):

	torch.cuda.empty_cache()

	tokenized_train, tokenized_valid, tokenized_test = load_processed_dataset(dataset_path)

	model, tokenizer, batch_size, data_collator = load_model_artifacts(model_checkpoint)

	train_model(model_checkpoint, batch_size, model, tokenized_train, tokenized_valid, data_collator, tokenizer)
...
if __name__ == "__main__":
	...
	master_function(dataset_path, output_path)
